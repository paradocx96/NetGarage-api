...
public class LaptopAdapterMongoImpl implements LaptopDataAdapter {
    ...
    public List<Laptop> findByBrand(String brand) {
        List<LaptopModel> laptopModels = repository.findByBrand(brand);

        List<Laptop> laptops = new ArrayList<>();

        for (LaptopModel laptopModel : laptopModels) {
            if (laptopModel.getStatus().equalsIgnoreCase("Activated")) {
                Laptop laptop = new Laptop();
    ...
    public List<Laptop> findByRamcapacity(String ramcapacity) {
        List<LaptopModel> laptopModels = repository.findByRamcapacity(ramcapacity);
    ...
    public List<Laptop> findByProcessorname(String processorname) {
        List<LaptopModel> laptopModels = repository.findByProcessorname(processorname);
